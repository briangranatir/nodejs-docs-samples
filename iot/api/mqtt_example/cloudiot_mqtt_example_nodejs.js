...
function publishAsync(messageCount, numMessages) {
  var payload = program.registry_id + '/' + program.device_id + '-payload-' +
      messageCount;
...
var mqttClientId = 'projects/' + program.project_id + '/locations/' +
    program.cloud_region + '/registries/' + program.registry_id + '/devices/' +
    program.device_id;
...
var connectionArgs = {
  ...
  username: 'unused',
  password: createJwt(
      program.project_id, program.private_key_file, program.algorithm),
  protocol: 'mqtts',
};
...
var mqttTopic = '/devices/' + program.device_id + '/events';
